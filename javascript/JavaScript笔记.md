...
![1498288494687](images/1498288494687.png)

#### 复杂类型在内存中的存储

![1498700592589](images/1498700592589.png)

#### 基本类型作为函数的参数

![1497497605587](images/1497497605587-8288640195.png)

#### 复杂类型作为函数的参数

![1497497865969](images/1497497865969.png)
...
function myFunction(){
  ...
  x.innerHTML=Math.floor((Math.random()*20)+10);
}
```
